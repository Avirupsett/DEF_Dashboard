...
const handleRowClick = async (mobileNo, vehicleNo, customerName) => {
  console.log('Clicked MobileNo:', mobileNo);
  ...
  try {
    ...
    if (vehicleNo) {
      requestBody.VehicleNo = vehicleNo;
    } else {
    ...
    setShowGraph(true);
    setIsBack(true);
    setClickedMobileNo(mobileNo || customerName || vehicleNo);
    setShowTable(false);
            ...
            <div style={{ overflowX: 'auto', overflowY: 'auto', maxHeight: '400px' }}>
              ...
              >
                ...
                <tbody {...getTableBodyProps()}>
                  ...
                  onClick={() => handleRowClick(row.original.MobileNo, row.original.VehicleNo, row.original.CustomerName)}
                      >
