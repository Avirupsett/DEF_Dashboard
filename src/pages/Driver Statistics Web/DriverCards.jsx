...
function DriverCards(props) {
    return (
        <div className="d-flex align-items-center justify-content-center my-1 flex-wrap">
            <div className='row my-1 d-flex justify-content-center align-items-stretch' style={{ width: '100%' }}>
                <div className="col-5 col-md-2 px-2 rounded-3 py-3 mt-1 mx-2 mb-2" style={{minWidth:"120px", fontSize: '12px', boxShadow: "rgba(0, 0, 0, 0.075) 0.1rem 0.1rem 1rem 2px", backgroundColor: "white" }}>
